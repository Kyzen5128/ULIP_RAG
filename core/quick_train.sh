#!/bin/bash
# =====================================================================
# ⚠️ DEPRECATED(2026-07-10 標記):本腳本為 4090 時代產物 —— conda env 名
# ulip_rag 已不存在(現為 ulip)、/mnt/data1/cheng/* 路徑在 3090 無效。
# 3090 正確指令見 docs/NEXT_TASKS_HANDOFF.md §1。僅供歷史參考,勿照跑。
# =====================================================================
# =============================================================================
# ULIP RAG 訓練快速啟動腳本
# =============================================================================
...
echo ""
echo "🎯 Step 3: 檢查預訓練模型..."
if [ ! -f "/mnt/P300/data/ULIP/ULIP-1/initialize_models/slip_base_100ep.pt" ]; then
    echo "⚠️  SLIP 預訓練模型未找到！"
    echo "正在下載... (約 400MB)"
    mkdir -p /mnt/P300/data/ULIP/ULIP-1/initialize_models
    cd /mnt/P300/data/ULIP/ULIP-1/initialize_models
