...
# =====================================================================
# ⚠️ DEPRECATED(2026-07-10 標記):本腳本用 CLIP ViT-B-32(512 維)建索引,
# 與現役 core/rag_corpus/clip_corpus_index.faiss(實測 384 維 MiniLM)不相容;
# 且預設路徑 ulip_rag/rag_corpus 已不存在(:10 附近)。
# ⚠️ 照跑會把現役索引覆蓋成不相容版本 —— 勿執行。
# =====================================================================
import open_clip
import torch
import faiss
